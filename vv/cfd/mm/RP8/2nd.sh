...
sed -i 's/^\s*MARKER_RIEMANN=.*$/MARKER_RIEMANN= ( 1, TOTAL_CONDITIONS_PT, 8e5, 500, 1.0, 0.0, 0.0, 4, TOTAL_CONDITIONS_PT, 1e5, 450, 1.0, 0.0, 0.0, 5, STATIC_PRESSURE, 1e5, 0, 0, 0, 0)/' su2.cfg
